...
company_mapping = {'Apple': 0, 'Dell': 1, 'HP': 2, 'Acer': 3, 'Lenovo': 4, 'Asus': 5, 'MSI': 6, 'Toshiba': 7, 'Razer': 8, 'Mediacom': 9}
...
company = st.selectbox('Brand', data['Company'].unique(), format_func=lambda x: company_mapping[x])
...
if st.button('Predict Price'):
    ...
    query = np.array([company_mapping[company], type_mapping[type], ram, weight,
